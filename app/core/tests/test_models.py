...
class ModelTests(TestCase):
    ...
    def test_create_recipe(self):
        ...
        recipe = models.Recipe.objects.create(user=user, title='Simple Recipe Name', time_minutes=5, price=5.00,
    ...
    def test_recipe_file_name_uuid(self, mock_uuid):
        """Test that recipe_file_name is saved in the database."""
        uuid = 'test-uuid'
