...
class PublicRecipeApiTests(TestCase):
    """Test Unauthenticated request API."""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def setUp(self):
        ...
        # self.user = get_user_model().objects.create_user('user@example.com', 'userpass123')
    ...
    def test_create_recipe(self):
        ...
        payload = {'title': 'Test recipe', 'time_minutes': 10, 'price': 5.00}
    ...
    def test_partial_update_recipe(self):
        ...
        recipe = create_recipe(user=self.user, title='Test recipe', link=original_link)
    ...
    def test_update_user_return_errors(self):
        """ Test updating user returns errors."""
    ...
    def test_recipe_other_users_recipe_error(self):
        """ Test deleting recipe with other user returns errors."""
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        payload = {'title': 'Test recipe', 'time_minutes': 10, 'price': Decimal('2.5'),
    ...
    def test_update_recipe_assign_tags(self):
        """Test updating recipe with tags."""
